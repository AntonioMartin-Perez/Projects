...
def run_svm_one_vs_rest_on_MNIST():
    ...
    train_y[train_y != 0] = 1
    test_y[test_y != 0] = 1
    pred_train_y = one_vs_rest_svm(train_x, train_y, train_x)
    # pred_test_y = one_vs_rest_svm(train_x, train_y, test_x)
    train_error = compute_test_error_svm(train_y, pred_train_y)
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    train_ymod3, test_ymod3 = update_y( train_y, test_y)

    theta, cost_function_history = softmax_regression(train_x, train_ymod3, temp_parameter, alpha= 0.3, lambda_factor = 1.0e-4, k = 10, num_iterations = 150)
    plot_cost_function_over_time(cost_function_history)
    test_error_mod3 = compute_test_error(test_x, test_ymod3, theta, temp_parameter)
...
theta_pca, cost_function_history = softmax_regression_no_augment(  train_pca, train_y, 1, alpha= 0.3, lambda_factor = 1.0e-4, k = 10, num_iterations = 150)

print("test_error =", compute_test_error(test_pca,test_y,theta_pca,1)  )
